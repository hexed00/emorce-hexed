...
export default function Header() {
  return (
    <header className="border-b border-hex-smoke/50 bg-hex-darker/90 backdrop-blur-md sticky top-0 z-30">
      <div className="max-w-6xl mx-auto px-4 py-3.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="flex items-center gap-2 text-xs font-mono text-hex-muted hover:text-[#5865F2] transition-colors group"
            title="discord.gg/emorce"
          >
            ...
            <span className="hidden sm:inline">discord.gg/emorce</span>
          </a>
